    ...
    <div className="container mx-auto max-w-screen-md px-4 py-16 sm:py-24">
      ...
      <div className="mt-8 space-y-6 text-muted-foreground leading-7">
        <section>
          ...
          <p className="mt-2">본 약관은 OhMyNextJS(이하 &quot;서비스&quot;)의 이용에 관하여 서비스 제공자와 이용자 간의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <p className="mt-2">본 약관은 서비스를 이용하고자 하는 모든 이용자에게 적용됩니다.</p>
        </section>
      </div>
    </div>
  );
